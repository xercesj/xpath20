...
fn:local-name-from-QName(
	if( false() ) then fn:QName("http://www.example.com/QNameXSD", xs:string(($input-context/root/elemQN)[1]))
	else fn:QName("http://www.example.com/QNameXSD", xs:string(($input-context/root/@attrQN)[1]))
) 
